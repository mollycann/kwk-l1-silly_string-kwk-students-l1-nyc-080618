...
your_favorite_word = "your_favorite_word".upcase
...
letter_count = big_word.capatilize # Put a . after big_word and use a String method.
...
proper_sentence = "i really like programming.".upcase # Put a . after the string to capitalize it properly.
...
sentence = sentence # gsub ("a", "A"), gsub ("O", "o")
